...
import com.example.asd_ass5_shop.databinding.FragmentPaymentBinding
    ...
    override fun onCreateView(
        ...
        bindig.mainBtnToNext.setOnClickListener {
            if (index.value!! < 4) {
                ...
                requireActivity().supportFragmentManager.beginTransaction().addToBackStack("payment").replace(
